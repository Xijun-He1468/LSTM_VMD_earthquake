# -*- coding: utf-8 -*-
"""
Created on Thu Nov 16 21:45:53 2023
...
plt.plot(x, inv_y, marker='*',markersize='1',color='g',linewidth=1, label='True latitude')
plt.plot(x, inv_yhat, marker='s',markersize='1', color='red',linestyle="--",linewidth=1,label='Predicting latitude')
